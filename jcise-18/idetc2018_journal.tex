\chapter{Defect-Free Kinematic Synthesis by Partial Shape Matching in a Clustered Database}\label{ch-ml-2018}
...
The original contributions of the work are in 1) creating a perceptive problem formulation for path and motion generation, which solves the issues associated with the precision position approach,
...
\begin{figure}
\centering
\includegraphics[width=240pt]{jcise-18/figure/path_solutions/hip_path.eps}
...
\centering
\begin{tabular}{cc}
  1)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol1.eps}}
    & 2)\putindeepbox[7pt]{\includegraphics[width=60pt]{jcise-18/figure/path_solutions/path_sol2.eps}} \\
  3)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol3.eps}}
    & 4)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol4.eps}}\\
  5)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol5.eps}}
    & 6)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol6.eps}} \\
  7)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol7.eps}}
    & 8)\putindeepbox[7pt]{\includegraphics[width=100pt]{jcise-18/figure/path_solutions/path_sol8.eps}}\\
\end{tabular}
...
\begin{figure}
\centering
\includegraphics[width=240pt]{jcise-18/figure/fig_motion_query.eps}
...
\centering
\begin{tabular}{cc}
  1)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol1.eps}}
    & 2)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol2.eps}} \\
  3)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol3.eps}}
    & 4)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol4.eps}}\\
  5)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol6.eps}}
    & 6)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol7.eps}} \\
  7)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol8.eps}}
    & 8)\putindeepbox[2pt]{\includegraphics[width=120pt]{jcise-18/figure/sol9.eps}}\\
\end{tabular}
...
Now we employ the approach presented in this chapter.
